            ...
            <form id="frm-main" class="">
                ...
                <div class="flex flex-col md:flex-row px-4 md:px-0 items-center justify-start mb-4">
                    ...
                    <div class="flex flex-row items-center md:justify-end mt-8 md:mt-0 md:ml-auto">
                        ...
                        @if (count($assignments) < 6)
                        <a id="addButton" href="{{ url('assignment') }}" class="text-indigo-800 hover:bg-[#e9f877] rounded-lg mr-2 font-extrabold text-sm px-2 py-1.5 text-center">
                            <svg class="w-6 h-6 text-indigo-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 18 18">
                        ...
                        <div class="flex items-center">
                            <div class="flex-column items-start ml-3">
                                ...
                                <div class="flex flex-row items-center justify-start mt-4 mb-2">
                                    <a href="{{ route('voto.create') }}" class="text-indigo-800 hover:bg-[#e9f877] rounded-lg mr-2 font-extrabold text-sm px-2 py-1.5 text-center">
                                    ...
                                    @if ($jrv->votos == 1)
                                    <a href="#" class="remove-jrv-button text-indigo-800 hover:bg-[#e9f877] rounded-lg mr-2 font-extrabold text-sm px-2 py-1.5 text-center">
                                        <div class="flex flex-row items-center justify-start">
