                        ...
                        <div class="flex items-center">
                            <div class="flex-column items-start ml-3">
                                ...
                                <div class="flex flex-row items-center justify-start mt-4 mb-2">                                  
                                    ...
                                    @else
                                    <a data-fiscal="{{ $fiscal->correo }}" class="xauth-button text-indigo-800 hover:bg-[#e9f877] rounded-lg mr-2 font-extrabold text-sm px-2 py-1.5 text-center cursor-pointer">
                                        <div class="flex flex-row items-center justify-start">
